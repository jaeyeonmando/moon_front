            ...
            services
              ...
              .map((service, index) => (
                <div key={index}>
                  ...
                  <p className="openssh-version">{service.name}</p>
                  <p>{service.description}</p>
                  <p>취약점 세부정보 : {service.vulnerabilityDetails}</p>
                  ...
                  <table className="port-info-table">
                    ...
                    <tbody>
                      <tr>
                        <td>공격 벡터</td>
                        <td>{service.attackVector}</td>
                      </tr>
                      <tr>
                        <td>공격 복잡성</td>
                        <td>{service.attackComplexity}</td>
                      </tr>
                      <tr>
                        <td>필요한 권한</td>
                        <td>{service.requiredPrivileges}</td>
                      </tr>
                      <tr>
                        <td>사용자 상호작용</td>
                        <td>{service.userInteraction}</td>
                      </tr>
                      <tr>
                        <td>범위</td>
                        <td>{service.scope}</td>
                      ...
                      <tr>
                        <td>기밀성</td>
                        <td>{service.confidentialityImpact}</td>
                      </tr>
                      <tr>
                        <td>무결성</td>
                        <td>{service.integrityImpact}</td>
                      </tr>
                      <tr>
                        <td>가용성</td>
                        <td>{service.availabilityImpact}</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
