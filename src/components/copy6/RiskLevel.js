        ...
        <div className="circle-chart">
          <div className="circle-background">
            <div
              ...
              style={{
                background: `conic-gradient(${combinedScore === 0 ? grayColor : '#5DADE2'} ${combinedScore * 10}%, #ecf0f1 0)`
              }}
            ></div>
          </div>
          <div className="circle-text">{(combinedScore * 10).toFixed(0)}%</div>
        </div>
        <h5>CVSS3 점수: {(combinedScore * 10).toFixed(2)}점</h5>
      </div>
        ...
        <div className="circle-chart">
          <div className="circle-background2">
            <div
              ...
              style={{
                background: `conic-gradient(${combinedScore === 0 ? grayColor : '#2980b9'} ${combinedScore * 10}%, #ecf0f1 0)`
              }}
            ></div>
          </div>
          <div className="circle-text" style={{ background: 'none', color: '#000000' }}>
            {(combinedScore * 10).toFixed(0)}%
          </div>

        </div>
        <h5>취약점 종합 점수: {(combinedScore * 10).toFixed(2)}점</h5>
      </div>
    </div>
  );
};
