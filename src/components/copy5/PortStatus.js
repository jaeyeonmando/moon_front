...
function PortState({ ip, setOpenPorts }) {
  const [ports, setPorts] = useState({}); // 초기 상태를 빈 객체로 설정
  ...
  useEffect(() => {
    // ports가 객체일 경우에만 Object.entries() 호출
